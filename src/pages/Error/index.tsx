...
export function Error(){
    return(
        <div className="bg-emerald-400 h-screen  items-center select-none flex justify-center flex-col ">
            ...
            <a href="/"><button className="mt-10 bg-header rounded-[7px] py-3 px-6 flex items-center justify-center cursor-pointer hover:scale-105 duration-200 text-white text-[20px]  font-extralight">voltar para Home</button></a>
